...
/// <summary>
/// Strategy for exporting plots to BMP format
/// </summary>
public class BmpExportStrategy : IImageExportStrategy
{
    public string FileExtension => ".bmp";
    public string FilterDescription => "BMP Files|*.bmp";
    ...
    public void ExportSinglePlot(Plot plot, string filePath, int width, int height)
    {
        ...
        plot.SaveBmp(filePath, width, height);
    }
